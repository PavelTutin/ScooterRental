...
public class ScooterController {
    ...
    @PatchMapping("/admin/setPrice/{scooterId}")
    public ResponseEntity<Void> editPrice(@PathVariable Long scooterId
    ...
    @PatchMapping("/admin/setStatus/{scooterId}")
    public ResponseEntity<Void> changeStatus(@PathVariable Long scooterId
